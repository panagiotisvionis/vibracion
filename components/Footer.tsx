        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-16 mb-20">
          ...
          <div className="reveal space-y-6">
            ...
            <div className="flex gap-3">
              {[
                { name: 'Instagram', href: 'https://www.instagram.com/eleni_christidou?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw==',
                ...
                { name: 'Facebook', href: 'https://www.facebook.com/profile.php?id=61555528775543&locale=el_GR',
          ...
          <div className="reveal d-100 space-y-6">
            ...
            <div className="space-y-4 text-sm">
              ...
              <a href="https://www.instagram.com/eleni_christidou?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw=="
